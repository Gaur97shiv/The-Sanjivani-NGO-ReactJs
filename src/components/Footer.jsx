                ...
                <div className="row">
                    <div className="col-lg-3 col-md-6">
                        <div className="footer-contact">
                            <h2>Contact Us</h2>
                            <a href="https://maps.app.goo.gl/HQg6gMPpAJ445cda6" target="_blank" rel="noopener noreferrer"><p><i className="fa fa-map-marker-alt"></i>Noida</p></a>
                            <a href="tel:+91-7385223242"><p><i className="fa fa-phone"></i>+91-953681808</p></a>
                            <a href="mailto:sanjivani.vitswd@vit.edu"><p><i className="fa fa-envelope"></i>navjeevannirmaansankalp@gmail.com</p></a>
                        </div>
                    </div>
                    <div className="col-lg-3 col-md-6">
